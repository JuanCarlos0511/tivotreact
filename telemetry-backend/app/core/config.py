...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = "http://localhost:3000,http://localhost:5173,http://localhost:5174,http://localhost:3001,https://tivot.tudominio.com,https://analytics.tudominio.com"
    LOG_LEVEL: str = "INFO"
