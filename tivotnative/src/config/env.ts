...
export const env = envSchema.parse({
  VITE_AI_PROVIDER: process.env.EXPO_PUBLIC_AI_PROVIDER,
  VITE_AI_API_KEY: process.env.EXPO_PUBLIC_AI_API_KEY,
  VITE_AI_BASE_URL: process.env.EXPO_PUBLIC_AI_BASE_URL,
  VITE_AI_MODEL_NAME: process.env.EXPO_PUBLIC_AI_MODEL_NAME,
  VITE_AI_TIMEOUT_MS: process.env.EXPO_PUBLIC_AI_TIMEOUT_MS,
  VITE_AI_TEMPERATURE: process.env.EXPO_PUBLIC_AI_TEMPERATURE,
  VITE_QWEN_API_KEY: process.env.EXPO_PUBLIC_QWEN_API_KEY,
  VITE_QWEN_BASE_URL: process.env.EXPO_PUBLIC_QWEN_BASE_URL,
  VITE_QWEN_MODEL: process.env.EXPO_PUBLIC_QWEN_MODEL,
})
