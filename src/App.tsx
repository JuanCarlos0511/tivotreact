...
import { ChatWorkspace, SettingsModal, Sidebar } from '@presentation/chat/components'
import { useTivotChatController } from '@presentation/chat/hooks/use-tivot-chat-controller'
...
function App() {
  ...
  const chat = useTivotChatController()
